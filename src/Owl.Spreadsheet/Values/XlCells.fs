...
type XlCells internal (cells: IXLCells) as self =
  ...
  member __.set_formula(value: string) = cells.FormulaA1 <- value; self
  member __.set_formula_r1c1(value: string) = cells.FormulaR1C1  <- value; self
