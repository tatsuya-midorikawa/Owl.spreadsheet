...
type XlCell internal (cell: IXLCell) as self =    
  ...
  member __.set<'T>(value: 'T) = __.value <- box value; self
  member __.fx(value: obj) = cell.FormulaA1 <- value.ToString(); self
  member __.get_formula() = cell.FormulaA1 
  member __.set_formula(value: string) = cell.FormulaA1  <- value; self
  member __.get_formula_r1c1() = cell.FormulaR1C1
  member __.set_formula_r1c1(value: string) = cell.FormulaR1C1  <- value; self
